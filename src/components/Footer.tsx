            ...
            <Container>
                <Row>
                    <Col className="col-12">
                        <svg className="footer-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 84 21" data-supported-dps="84x21" fill="currentColor" width="84" height="21" focusable="false">
                            <g>
                                <g>
                ...
                <Row className="mt-2">
                    <Col className="col-12 col-sm-6">
                        <Row>
                            <Col className="col-12 col-sm-4"><Link to="/">About</Link></Col>
                            <Col className="col-12 col-sm-4"><Link to="/">Accessibility</Link></Col>
                            <Col className="col-12 col-sm-4"><Link to="/">Talent Solutions</Link></Col>
                            <Col className="col-12 col-sm-4"><Link to="/">Community Guidelines</Link></Col>
                            <Col className="col-12 col-sm-4"><Link to="/">Careers</Link></Col>
                            <Col className="col-12 col-sm-4"><Link to="/">Marketing Solutions</Link></Col>
                            <Col className="col-12 col-sm-4"><Link to="/"><NavDropdown title="Privacy & Terms" id="basic-nav-dropdown">
                                <NavDropdown.Item href="#action/3.1">Privacy Policy</NavDropdown.Item>
                                <NavDropdown.Item href="#action/3.2">User Agreement</NavDropdown.Item>
                                <NavDropdown.Item href="#action/3.3">Cookie Policy</NavDropdown.Item>
                                <NavDropdown.Item href="#action/3.3">Copyright Policy</NavDropdown.Item>
                            </NavDropdown></Link></Col>
                        ...
                        <Row>
                            ...
                            <Col className="pr-4">
                                ...
                                <div className="language">
                                    <NavDropdown title="English (English)" id="basic-nav-dropdown">
                                        <NavDropdown.Item href="#action/3.3">العربية (Arabic)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">Čeština (Czech)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">Danks (Danish)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.1">Deutsch (German)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">English (English)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">Español (Spanish)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">Français (French)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">हिन्दी (Hindi)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.2">Italiano (Italian)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">한국어 (Korean)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">Nederlands (Dutch)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">Norsk (Norvegian)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">Polski (Polish)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">Swenska (Swedish)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">Tagalog (Tagalog)</NavDropdown.Item>
                                        <NavDropdown.Item href="#action/3.3">Türkçe (Turkish)</NavDropdown.Item>
                                    </NavDropdown>
                                </div>
                            </Col>
                        </Row>
                ...
                <Row className="my-3">
                    <Col> <span>LinkedIn Corporation © 2023</span></Col>
                </Row>
            </Container>
        </div >
    )
