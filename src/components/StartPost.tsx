        ...
        <>
                    ...
                    <div className="main-container">
                        <div className="d-flex">
                            ...
                            <div className="button-container">
                                <Button onClick={handleShow} className="start-post-btn badge-pill">Start a post</Button>
                            </div>
                        </div>
                        <div className="d-flex justify-content-between px-2 mt-2 options-container">
            ...
            <Modal show={show} onHide={handleClose} className="post-modal">
                <Modal.Header closeButton>
                    <Modal.Title style={{ fontWeight: "400", fontSize: "20px" }}>Create a post</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <div className="d-flex">
                        <div className="image-container">
                        ...
                        <div className="d-flex flex-column">
                            ...
                            <Button variant="outline-secondary" className="badge-pill py-0 d-flex align-items-center">
                                ...
                                Anyone
                                <svg className="ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" data-supported-dps="16x16" fill="currentColor" width="16" height="16" focusable="false">
                    ...
                    <div className="d-flex align-items-center">
                        <svg className="mr-1 emoji" style={{ fill: "rgba(0, 0, 0, 0.6)", cursor: "pointer" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" width="24" height="24" focusable="false">
                        ...
                        <Link className="hashtag-link" to={"/"}>Add Hashtag</Link>
                    </div>
                </Modal.Body>
                <Modal.Footer>
