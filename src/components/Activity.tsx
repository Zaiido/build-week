    ...
    <Container className="mb-5" >
      <Row  >
        <Col className="mt-2 sub-sections" style={{ paddingInline: "0" }}>
          <div className="d-flex justify-content-between align-items-center" style={{ paddingInline: "15px" }}>
            <div>
              ...
              <p className="connections mt-2 mb-1 px-2 ">
                <a href="#home" className="link-connections">494 Followers</a>
              </p>
            </div>
          ...
          <h6 style={{ fontWeight: "600", paddingInline: "23px" }}>You haven't posted lately</h6>
          <p className="about" style={{ paddingInline: "23px" }}>Recent posts you share or comment on will be displayed here</p>
          <ListGroup>
            <ListGroup.Item className="activity-item">
              <div className='text-center'>
                <a href="#home">Show all activity<ArrowRight className='ml-2' /></a>
              </div></ListGroup.Item>
          </ListGroup>
        </Col>
      </Row>
